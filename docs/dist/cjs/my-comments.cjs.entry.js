...
let MyComments = class {
  ...
  renderComment(comment) {
    return (index.h("article", { role: "comment" }, index.h("header", null, index.h("h1", null, comment.author_id)), index.h("p", null, comment.content), index.h("footer", null, index.h("small", null, index.h("time", { dateTime: comment.created_at }, comment.created_at)))));
  }
  render() {
    return (index.h(index.Host, null, index.h("h2", null, "Comments"), index.h("form", { onSubmit: (ev) => this.handleSubmit(ev) }, index.h("textarea", { rows: 5, placeholder: "Add a comment...", value: this.newCommentValue, onChange: (ev) => this.handleChange(ev) }), index.h("input", { type: "submit", value: "Submit" })), this.comments.map(comment => this.renderComment(comment))));
  }
  get element() { return index.getElement(this); }
};
MyComments.style = myCommentsCss;

exports.my_comments = MyComments;
