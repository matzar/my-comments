...
const fetch = /*@__PURE__*/getDefaultExportFromCjs(browserPonyfill);
...
const myCommentsCss = ":host{display:block;font-family:sans-serif}article[role='comment']{margin-top:1rem;padding:1rem;border:2px solid black;border-radius:0.5rem;box-shadow:black 5px 5px}form{display:flex;flex-direction:column}form textarea{width:100%;border-radius:5px;border:2px solid lightgray;resize:vertical;padding:0.5rem;box-sizing:border-box}form input[type='submit']{background-color:black;color:white;border:none;border-radius:5px;text-align:start;max-width:min-content;margin-top:0.5rem;padding:0.5rem}";

let MyComments$1 = class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
  ...
  renderComment(comment) {
    return (h("article", { role: "comment" }, h("header", null, h("h1", null, comment.author_id)), h("p", null, comment.content), h("footer", null, h("small", null, h("time", { dateTime: comment.created_at }, comment.created_at)))));
  }
  render() {
    return (h(Host, null, h("h2", null, "Comments"), h("form", { onSubmit: (ev) => this.handleSubmit(ev) }, h("textarea", { rows: 5, placeholder: "Add a comment...", value: this.newCommentValue, onChange: (ev) => this.handleChange(ev) }), h("input", { type: "submit", value: "Submit" })), this.comments.map(comment => this.renderComment(comment))));
  }
  get element() { return this; }
  static get style() { return myCommentsCss; }
};
MyComments$1 = /*@__PURE__*/ proxyCustomElement(MyComments$1, [1, "my-comments", {
    "supabseUrl": [1, "supabse-url"],
    "supabaseKey": [1, "supabase-key"],
    "comments": [32],
    "newCommentValue": [32]
  }]);
function defineCustomElement$1() {
  ...
  const components = ["my-comments"];
  components.forEach(tagName => { switch (tagName) {
    case "my-comments":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, MyComments$1);
      }
      break;
  } });
}

const MyComments = MyComments$1;
const defineCustomElement = defineCustomElement$1;

export { MyComments, defineCustomElement };
